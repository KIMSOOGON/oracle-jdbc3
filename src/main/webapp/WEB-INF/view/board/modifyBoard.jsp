...
<body style="background-color:rgb(233,233,233)" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
	...
	<div class="row">
		...
		<div class="container mt-5 col text-center" style="position:relative; right:150px">
			<img src="${pageContext.request.contextPath}/img/cloud4.jpg" style="width:400px">
		</div>
		...
		<div class="col container mt-4" style="position:relative; right:150px">
			<div class="shadow p-5">
				...
				<br>
				<p class="text-center">- 게시글 수정 -</p>
				<form action="${pageContext.request.contextPath}/board/modifyBoard" method="post" id="modifyBoardForm">
					<div><input type="hidden" name="boardNo" value="${boardOne.boardNo}"></div>
					<table class="table table-hover">
						<tr>
							<td>
								<input type="text" name="boardTitle" value="${boardOne.boardTitle}" id="boardTitle" style="width:400px">
								
							</td>
							<td>작성자 : <input type="text" name="memberId" value="${boardOne.memberId}" readonly="readonly" style="width:100px"></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">
								<textarea rows="10" cols="80" name="boardContent" id="boardContent">${boardOne.boardContent}</textarea>
							</td>
						</tr>
					</table>
					<div>
						<a class="btn btn-sm btn-outline-dark" href="${pageContext.request.contextPath}/board/boardOne?boardNo=${boardOne.boardNo}">취소</a>
						<button class="btn btn-sm btn-outline-dark" type="button" id="modifyBoardBtn">수정</button>
					</div>
				</form>
			</div>
		</div>
